...
export class CallsArchiveComponent implements OnInit, OnDestroy {
  ...
  descriptions: ISimpleDescription[] = [
    ...
    },
    {
      ...
      type: 'select',
      selectList: [
        {name: 'Бригада не назначена', id: 0},
        {name: 'Не принят бригадой', id: 1},
        // {name: 'Активный', id: [2]},
        {name: 'В работе', id: 3},
        {name: 'Завершен', id: 4},
  ...
  searchCalls() {
    ...
    this.filters.callStatusList = (this.filters.callStatusList !== null && this.filters.callStatusList !== undefined)  ? [this.filters.callStatusList] : undefined;
  }
