...
export interface IDictionaryInfo {
  ...
  endField?: string; // поле конечного узла (узел у которому нельзя создать детей)
}
...
//   },
  ...
  },
  {
    ...
    type: 'tree',
    name: 'mkb10',
    method: 'getMkbNodeNextLevelUsingGET',
    block: 'common',
    headers: [
      {
        header: '',
    ...
    item: {
      ...
      fullListMethod: 'getFullClassMkbListUsingGET',
  ...
  },
  {
    ...
    method: 'listOfInsuranceCompanyUsingGET',
    block: 'common',
    paramsOrder: ['name', 'code'],
    filters: [
      {
    ...
    item: {
      ...
      blocks: [{title: '', key: 'common'}],
      method: 'getInsuranceCompanyUsingGET',
      restoreMethod: 'restoreInsuranceCompanyUsingGET',
      saveMethod: 'updateInsuranceCompanyUsingPOST',
      deleteMethod: 'deleteInsuranceCompanyUsingDELETE',
    }
  }
];
